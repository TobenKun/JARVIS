...
class AgentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Process = channel.unary_unary(
                '/agent.AgentService/Process',
                request_serializer=agent__pb2.UserInput.SerializeToString,
                response_deserializer=agent__pb2.AgentResponse.FromString,
                _registered_method=True)
        self.Capabilities = channel.unary_unary(
                '/agent.AgentService/Capabilities',
...
def add_AgentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Process': grpc.unary_unary_rpc_method_handler(
                    servicer.Process,
                    request_deserializer=agent__pb2.UserInput.FromString,
...
class AgentService(object):
    ...
    def Process(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/agent.AgentService/Process',
            agent__pb2.UserInput.SerializeToString,
